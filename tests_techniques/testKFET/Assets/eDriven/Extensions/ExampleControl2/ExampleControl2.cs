...
Recipients should be delimited with "";"" and formatted as ""mail@domain.com"".";
        ...
        override protected void CreateChildren()
        {
            ...
            HBox hbox = new HBox { PercentWidth = 100 };
            ...
            _txtMessage = new TextField {PercentWidth = 100, Height = 150, Multiline = true };
            _form.AddField("message", "Message: ", _txtMessage);

            HBox hbox2 = new HBox { PercentWidth = 100, HorizontalAlign = HorizontalAlign.Right };
        ...
        protected override void CreationComplete()
        {
            ...
            var parent = (Container)_txtCc.Parent;
            parent.Visible = parent.IncludeInLayout = _btnCc.Selected;

            parent = (Container)_txtBcc.Parent;
        ...
        private void PressHandler(Event e)
        {
            ...
            {
                var parent = (Container)_txtBcc.Parent;
                parent.Visible = parent.IncludeInLayout = _btnBcc.Selected;
            }
        ...
        private void SendMessage()
        {
            ...
            {
                var e = new ExampleEvent2(ExampleEvent2.SEND_MESSAGE)
                {
